            ...
            switch (args.Slot)
            {
                case SpellSlot.R:
                    ...
                    if (Vars.Menu[objAiHero.ChampionName.ToLower()]["ultimate"].GetValue<MenuBool>().Value)
                    {
                        ...
                        /// </summary>
                        DelayAction.Add(
                            (float) WeightedRandom.Next(5000, 10000),
                            () =>
                                {
                                    ...
                                    {
                                        case 1:
                                            Chat.Print($"{Vars.GetHumanName(objAiHero.ChampionName.ToLower())} no ulti");
                                            break;
                                        case 2:
                                            Chat.Print($"no ult {Vars.GetHumanName(objAiHero.ChampionName.ToLower())}");
                                            break;
                                        case 3:
                                            Chat.Print($"ult {Vars.GetHumanName(objAiHero.ChampionName.ToLower())}");
                                            break;
                                        default:
                                            Chat.Print($"{Vars.GetHumanName(objAiHero.ChampionName.ToLower())} ult");
                                            break;
                                    }
                                });
                    }
