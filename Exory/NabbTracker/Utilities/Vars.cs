...
namespace NabbTracker
{
    ...
    internal class Vars
    {
        ...
        public static int ExpYAdjustment(AIHeroClient target)
        {
            ...
            {
                return Menu["miscellaneous"]["name"].GetValue<MenuBool>().Value ? -65 : -38;
            }

            return target.IsMe
                       ? Menu["miscellaneous"]["name"].GetValue<MenuBool>().Value ? -58 : -30
                       : Menu["miscellaneous"]["name"].GetValue<MenuBool>().Value ? -51 : -22;
        }
